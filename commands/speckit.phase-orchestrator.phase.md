---
description: "Use /speckit.phase-orchestrator.phase or $speckit-phase-orchestrator-phase to run Spec Kit tasks.md one phase at a time with isolated workers, validation, docs, and parent-owned commits."
---
